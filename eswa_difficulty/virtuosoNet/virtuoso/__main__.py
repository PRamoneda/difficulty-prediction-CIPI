...
from eswa_difficulty.virtuosoNet.virtuoso.parser import get_parser, get_name
from eswa_difficulty.virtuosoNet.virtuoso import utils
from eswa_difficulty.virtuosoNet.virtuoso.train import train
from eswa_difficulty.virtuosoNet.virtuoso.model import VirtuosoNet
from eswa_difficulty.virtuosoNet.virtuoso.inference import inference, inference_with_emotion
...
def main():
    ...
    model = VirtuosoNet(net_param, data_stats, args=args)
